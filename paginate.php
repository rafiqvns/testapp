...
function paginate($reload, $page, $tpages) {
    ...
    // previous
    if ($page == 1) {
        $out.= "<span style='float:left;'> " . $prevlabel . "</span>\n";
    } elseif ($page == 2) {
    ...
    // next
    if ($page < $tpages) {
        $out.= "<li style='font-size:11px;float:right;'><a  href=\"" . $reload . "&amp;page=" . ($page + 1) . "\">" . $nextlabel . "</a>\n</li>";
    } else {
        $out.= "<span style='font-size:11px;float:right;'>" . $nextlabel . "</span>\n";
    }
    $out.= "";
    return $out;
}
